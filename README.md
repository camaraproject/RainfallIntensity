<a href="https://github.com/camaraproject/RainfallIntensity/commits/" title="Last Commit"><img src="https://img.shields.io/github/last-commit/camaraproject/RainfallIntensity?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity/issues" title="Open Issues"><img src="https://img.shields.io/github/issues/camaraproject/RainfallIntensity?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity/pulls" title="Open Pull Requests"><img src="https://img.shields.io/github/issues-pr/camaraproject/RainfallIntensity?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity/graphs/contributors" title="Contributors"><img src="https://img.shields.io/github/contributors/camaraproject/RainfallIntensity?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity" title="Repo Size"><img src="https://img.shields.io/github/repo-size/camaraproject/RainfallIntensity?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity/blob/main/LICENSE" title="License"><img src="https://img.shields.io/badge/License-Apache%202.0-green.svg?style=plastic"></a>
<a href="https://github.com/camaraproject/RainfallIntensity/releases/latest" title="Latest Release"><img src="https://img.shields.io/github/release/camaraproject/RainfallIntensity?style=plastic"></a>
...
Sandbox API Repository to describe, develop, document, and test the RainfallIntensity Service API(s). The repository does not yet belong to a CAMARA Sub Project.

* API Repository [wiki page](https://lf-camaraproject.atlassian.net/wiki/x/DYDEH)

---
<!-- Alternative for Sandbox API Repositories within the context of an existing Sub Project. Choose the "Sandbox" badge above -->

Sandbox API Repository to describe, develop, document, and test the RainfallIntensity Service API(s) within the Sub Project []().
...
Incubating API Repository to evolve and maintain the definitions and documentation of RainfallIntensity Service API(s) within the Sub Project []()
...
* Working Group [wiki home page](https://lf-camaraproject.atlassian.net/wiki/x/DYDEH) 
...
* Meetings are held virtually <!-- for new, independent Sandbox API repositories request a meeting link from the LF admin team or replace the information with the existing meeting information of the Sub Project -->
  ...
  * Minutes: Access [meeting minutes](https://lf-camaraproject.atlassian.net/wiki/x/DYDEH) !! update this link to your minutes archive page using the "Share" link and delete the task
* Mailing List
  <!-- Note: the `mailinglistname` is either already existing (for API Repositories within a Sub Projects) or will be created by the CAMARA Admin Team. -->
  * Subscribe / Unsubscribe to the mailing list <https://lists.camaraproject.org/g/sp-rainfall-intensity>.
  * A message to the community of this Sub Project can be sent using <sp-rainfall-intensity@lists.camaraproject.org>.
